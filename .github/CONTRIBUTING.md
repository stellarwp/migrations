...
Thank you for contributing to Migrations! This guide outlines the standards and processes for commits and pull requests.
...
```php
/**
 * That's a dummy method.
 *
 * This is a dummy method which i want to specify something in more details.
 *
 * @since 1.0.0
 *
 ...
 */
public function run( string $migration ): array {
    return [
        'success' => true,
